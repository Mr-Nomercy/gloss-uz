...
import 'package:gloss_provider/screens/splash_screen.dart';
import 'package:gloss_provider/screens/auth_screen.dart';
import 'package:gloss_provider/screens/home_screen.dart';
import 'package:gloss_provider/screens/orders_screen.dart';
import 'package:gloss_provider/screens/order_detail_screen.dart';
import 'package:gloss_provider/screens/stats_screen.dart';
import 'package:gloss_provider/screens/wallet_screen.dart';
import 'package:gloss_provider/screens/profile_screen.dart';
...
void main() {
  testWidgets('SplashScreen renders', (tester) async {
    ...
    await tester.pump();
    expect(find.text('Gloss Provider'), findsOneWidget);
