...
import 'package:gloss_worker/screens/splash_screen.dart';
import 'package:gloss_worker/screens/auth_screen.dart';
import 'package:gloss_worker/screens/home_screen.dart';
import 'package:gloss_worker/screens/orders_screen.dart';
import 'package:gloss_worker/screens/order_detail_screen.dart';
import 'package:gloss_worker/screens/stats_screen.dart';
import 'package:gloss_worker/screens/wallet_screen.dart';
import 'package:gloss_worker/screens/profile_screen.dart';
...
void main() {
  testWidgets('SplashScreen renders', (tester) async {
    ...
    await tester.pump();
    expect(find.text('Gloss Worker'), findsOneWidget);
