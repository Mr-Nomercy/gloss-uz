...
export default function PlatformDashboard() {
  const stats = [
    ...
    { label: 'Bugungi buyurtmalar', value: '24 ta', icon: ShoppingBag, color: 'text-blue-600', bg: 'bg-blue-50' },
    { label: 'Aktiv tenantlar', value: '5 ta', icon: Store, color: 'text-purple-600', bg: 'bg-purple-50' },
    {
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={revenueData}>
              ...
              <YAxis stroke="#757575" fontSize={12} tickFormatter={(v) => `${(v / 1000000).toFixed(0)}M`} />
              <Tooltip formatter={(value: number) => [formatCurrency(value), 'Daromad']} />
