    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-8 text-center">
          <div className="text-5xl font-bold text-gloss-green">{avgRating.toFixed(1)}</div>
          ...
          <p className="mt-2 text-gloss-hint">O'rtacha reyting ({mockReviews.length} ta sharh)</p>
        </CardContent>
      </Card>
