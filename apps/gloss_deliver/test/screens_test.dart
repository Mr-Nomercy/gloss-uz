...
import 'package:gloss_deliver/screens/splash_screen.dart';
import 'package:gloss_deliver/screens/onboarding_screen.dart';
import 'package:gloss_deliver/screens/login_screen.dart';
import 'package:gloss_deliver/screens/register_screen.dart';
import 'package:gloss_deliver/screens/verify_phone_screen.dart';
import 'package:gloss_deliver/screens/home_screen.dart';
import 'package:gloss_deliver/screens/orders_screen.dart';
import 'package:gloss_deliver/screens/stats_screen.dart';
import 'package:gloss_deliver/screens/profile_screen.dart';
...
void main() {
  group('SplashScreen', () {
    testWidgets('renders logo and brand name', (tester) async {
      ...
      expect(find.text('Gloss Deliver'), findsOneWidget);
