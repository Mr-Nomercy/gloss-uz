...
class AuthNotifier extends StateNotifier<AuthState> {
  ...
  Future<bool> login(String email, String password) async {
    ...
    if (email == 'admin@gloss.uz' && password == 'admin123') {
      await _storage.write(key: 'admin_access_token', value: 'demo_token');
      await _storage.write(key: 'admin_refresh_token', value: 'demo_refresh');
